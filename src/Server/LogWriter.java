...
//            if(this.logFileName==null){this.logFileName=DEFAULT_LOG_FILE_NAME;
//            }
//        }
//
//        File logFile = new File(this.logFileName);
//        // FileWriter()第1个参数的含义是:是否在文件中追加内容
//        // PrintWriter()第2个参数的含义是：自动将数据flush到文件中
//        try{
...
//        try{
//            Properties pro = new Properties();//在类的当前位置,查找属性配置文件
//            log.propertiesInputStream fin = getClass().getResourceAsStream(LOG_CONFIGFILE_NAME);
//            if(fin!=null){
//                pro.load(fin);//载入配置文件
//                fin.close();
